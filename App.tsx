...
import { ViewType, SiteConfig, Post } from './types';
  ...
  const PublicView = () => (
    <div className="animate-fadeIn">
      ...
      <section id="home" className="relative h-[850px] flex items-center overflow-hidden bg-gray-900">
        ...
        {/* Floating Decorative Text: FANTASTIC CLARK */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              ...
              <img 
                ...
                alt="Newer Vision Agency Resort View" 
            ...
            <div>
              ...
              <div className="text-gray-700 text-base leading-relaxed mb-8 space-y-4">
                <p>안녕하십니까. NEWER VISION <span className="font-bold text-gray-900 underline decoration-purple-200">대표 John KIM</span>입니다. 우리 NEWER VISION은 클락 카지노 산업의 정켓운영을 시작으로 AGENCY를 설립했습니다. 또한, 코로나 시기에도 끝까지 견디면서 저력을 보여 왔습니다.</p>
                <p>현재 카지노 산업은 유례 없는 경기의 혹한기를 겪고 있으나, 이러한 위기를 극복하여 성장할 수 있는 DNA가 NEWER VISION에는 내재되어 있습니다. 이를 바탕으로 어떠한 상황 속에서도 ‘최고의 경쟁력’을 가진 회사로 도약하기 위해 고객님들께 더 나은 서비스를 제공하고 있습니다. 비슷해 보이지만 분명히 다른 차별화를 통해 고객님께 안전하고 의지할 수 있는 쉼터가 되겠습니다.</p>
      ...
      <section id="staff" className="py-24 bg-gray-50 overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 pb-12">
          <div className="flex flex-col items-center">
            ...
            {/* Straight Vertical Connector Line */}
            <div className="w-0.5 h-12 bg-purple-600/10"></div>
            <div className="w-0.5 h-12 bg-green-200"></div>

            {/* Operations Director */}
            <div className="relative flex flex-col items-center">
              <a 
                href="http://pf.kakao.com/_aRlxon/chat" 
                target="_blank" 
                rel="noopener noreferrer" 
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="group">
                  <div className="w-80 bg-red-100 text-red-900 px-6 py-8 rounded-3xl shadow-2xl border-4 border-red-200 relative z-10 transition-transform group-hover:scale-105 flex flex-col items-center justify-center min-h-[140px] text-center">
                    ...
                    <h3 className="text-2xl font-black tracking-tight flex items-baseline justify-center mb-1">
                      <span className="text-sm font-bold mr-2 text-purple-700">사원</span>
                      ERIC SONG
                    </h3>
      ...
      <section id="reservation" className="py-24 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-purple-700 to-indigo-900 rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl">
            ...
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-purple-400 opacity-5 rounded-full translate-y-1/2 -translate-x-1/2"></div>
            
            <div className="relative z-10">
              <span className="inline-block px-4 py-1.5 bg-white/10 backdrop-blur-sm text-white text-xs font-bold rounded-full border border-white/20 mb-8 uppercase tracking-[0.3em]">
                Direct Consultation
              </span>
              ...
              <p className="text-purple-100 text-lg md:text-xl mb-12 max-w-2xl mx-auto font-light leading-relaxed">
                수 많은 고객님과 울고 웃었던 세월은 모방할 수 없습니다.
              </p>
              ...
              <div className="mt-16 flex items-center justify-center space-x-8 opacity-50 grayscale hover:grayscale-0 transition-all">
                 <span className="text-white font-bold text-xs border border-white/20 px-3 py-1 rounded">HANN CASINO</span>
                 <span className="text-white font-bold text-xs border border-white/20 px-3 py-1 rounded">ROYCE CASINO</span>
                 <span className="text-white font-bold text-xs border border-white/20 px-3 py-1 rounded">HILTON CASINO</span>
              </div>
            </div>
          </div>
        </div>
